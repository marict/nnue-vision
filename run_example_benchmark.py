...
Usage:
    # Train a model first
    python train.py --config config/train_default.py --max_epochs 20
...
def main():
    ...
    if model_path.exists():
        ...
        print("   (For real benchmarks, train a model first with: python train.py)")
        model = create_example_model()
    ...
    print(f"\n🚀 Next Steps:")
    print(f"   1. Train a real model: python train.py --config config/train_default.py")
    print(
